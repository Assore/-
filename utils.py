...
def load_model(params):
    ...
    if model_type in {'akt'}:
        # model = AKT(params.n_question, params.n_pid,d_model=params.d_model,n_blocks=params.n_block,
        #             dropout=params.dropout, kq_same=params.kq_same).to(device)

        model = LMKT(n_question=params.n_question, n_pid=params.n_pid, n_blocks=params.n_block, d_model=params.d_model,
